...
const CLIENT_ID='915576215474-2j3iu3s6funbra6eiq6guuom6p5lnu5n.apps.googleusercontent.com'
const CLIENT_SECRET='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'
const REDIRECT_URI='https://developers.google.com/oauthplayground'
const REFRESH_TOKEN='1//04asfqYa6Z1nhCgYIARAAGAQSNwF-L9Ir9qZRiek-hddnC7kCOM5VzyDrA2b66y-Wjz5KM2uD1WZuQXbs814l2DURzWYDiKZZf50'
...
export  async function forgetemail(to_email,token){
    try {
        ...
        const mailOptions={
            ...
            to:to_email,
            subject:"Reset your password for BookStoreusing this link",
            text:"text mess",
